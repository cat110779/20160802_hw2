...
SET DEFINE OFF;
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (2,'admin','admin','admin@gmail.com',8315,to_timestamp('23-5月 -16 02.01.09.550000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'高級會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (20,'fju','fju','nomad341725@gmail.com',0,to_timestamp('04-6月 -16 09.34.46.398000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (23,'aaa','aaa','nomad341725@gmail.com',0,to_timestamp('06-6月 -16 02.37.24.477000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (17,'gundam','gun','gundam',0,to_timestamp('04-6月 -16 08.48.39.558000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (12,'Dasein','being','Dasein',0,to_timestamp('27-5月 -16 02.26.32.414000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (15,'a183','123123','a183cute33@gmail.com',0,to_timestamp('27-5月 -16 05.08.28.859000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (16,'moon','moon','nomad341725@gmail.com',0,to_timestamp('04-6月 -16 08.45.15.983000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (26,'jeffery','123','1231@gmail.com',0,to_timestamp('07-6月 -16 08.19.58.578000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (6,'rain','RR54qy','nomad341725@gmail.com',0,to_timestamp('27-5月 -16 03.10.50.682000000 上午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (8,'rainy','rainy','rainy',0,to_timestamp('27-5月 -16 03.27.33.999000000 上午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (25,'cypher','cypher','nomad341725@gmail.com',0,to_timestamp('07-6月 -16 04.09.13.633000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (11,'sun','sun','sun',420,to_timestamp('27-5月 -16 03.30.12.094000000 上午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (22,'zeit','zeit','nomad341725@gmail.com',0,to_timestamp('05-6月 -16 01.13.20.779000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (27,'hddoddiod','123','djdddjj@gmail.com',0,to_timestamp('07-6月 -16 08.21.28.626000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
Insert into MEMBER (ID,ACCOUNT,PASSWORD,EMAIL,CASH,CREATE_DATE,M_TYPE) values (33,'jeffery840106','51RO5752','a183cute33@gmail.com',0,to_timestamp('07-6月 -16 08.47.07.947000000 下午','DD-MON-RR HH.MI.SSXFF AM'),'一般會員');
REM INSERTING into M_ORDER
SET DEFINE OFF;
REM INSERTING into ORDERS
SET DEFINE OFF;
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (121,7,to_timestamp('08-6月 -16 08.12.59.527000000 下午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('08-6月 -16 09.12.00.000000000 下午','DD-MON-RR HH.MI.SSXFF AM'),100,'admin','已結單',null,'鬍鬚張');
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (122,10,to_timestamp('08-6月 -16 08.14.01.165000000 下午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('08-6月 -16 09.13.00.000000000 下午','DD-MON-RR HH.MI.SSXFF AM'),500,'admin','已結單',null,'魏姐包心粉圓');
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (123,1,to_timestamp('09-6月 -16 01.30.25.807000000 上午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('09-6月 -16 02.30.00.000000000 上午','DD-MON-RR HH.MI.SSXFF AM'),300,'admin','已結單',null,'麥當勞');
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (124,1,to_timestamp('13-6月 -16 09.57.05.925000000 下午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('13-6月 -16 10.56.00.000000000 下午','DD-MON-RR HH.MI.SSXFF AM'),100,'admin','已結單',null,'麥當勞');
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (120,7,to_timestamp('08-6月 -16 08.06.32.872000000 下午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('08-6月 -16 09.05.00.000000000 下午','DD-MON-RR HH.MI.SSXFF AM'),700,'admin','已結單',null,'鬍鬚張');
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (118,10,to_timestamp('08-6月 -16 12.52.51.228000000 下午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('08-6月 -16 01.52.00.000000000 下午','DD-MON-RR HH.MI.SSXFF AM'),100,'admin','已截止',null,'魏姐包心粉圓');
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (119,1,to_timestamp('08-6月 -16 02.27.32.222000000 下午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('08-6月 -16 03.27.00.000000000 下午','DD-MON-RR HH.MI.SSXFF AM'),500,'admin','已截止',null,'麥當勞');
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (116,2,to_timestamp('08-6月 -16 12.52.27.407000000 下午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('08-6月 -16 01.52.00.000000000 下午','DD-MON-RR HH.MI.SSXFF AM'),100,'admin','已截止',null,'悟饕池上飯包');
Insert into ORDERS (ID,RESTAURANT_ID,BEGIN_TIME,END_TIME,END_MONEY,MEMBER_ACCOUNT,STATUS,INFO,RESTAURANT_NAME) values (117,2,to_timestamp('08-6月 -16 12.52.27.639000000 下午','DD-MON-RR HH.MI.SSXFF AM'),to_timestamp('08-6月 -16 01.52.00.000000000 下午','DD-MON-RR HH.MI.SSXFF AM'),100,'admin','已截止',null,'悟饕池上飯包');
